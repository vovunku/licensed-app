...
export declare const getPostMessageStream: ({ name, communicationLayerPreference, remoteConnection, walletConnect, debug, }: GetPostMessageStreamProps) => PostMessageStream;
