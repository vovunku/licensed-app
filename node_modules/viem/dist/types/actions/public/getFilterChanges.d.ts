...
export type GetFilterChangesParameters<TFilterType extends FilterType = FilterType, TAbi extends Abi | readonly unknown[] = Abi, TEventName extends string | undefined = string> = {
    filter: Filter<TFilterType, TAbi, TEventName, any>;
};
export type GetFilterChangesReturnType<TFilterType extends FilterType = FilterType, TAbi extends Abi | readonly unknown[] = Abi, TEventName extends string | undefined = string, _AbiEvent extends AbiEvent | undefined = TAbi extends Abi ? TEventName extends string ? ExtractAbiEvent<TAbi, TEventName> : undefined : undefined> = TFilterType extends 'event' ? Log<bigint, number, _AbiEvent, TAbi, TEventName>[] : Hash[];
/**
